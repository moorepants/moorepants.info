...
rsync_upload: publish
	...
	# -v : verbose
	# -zc : compress choice
	# --cvs-exclude : auto ignore files in the same way cvs does (removed)
	# --delete : delete extraneous files from destination directory (removed)
	rsync -e "ssh -p $(SSH_PORT)" -P -rvzc $(OUTPUTDIR)/ $(SSH_USER)@$(SSH_HOST):$(SSH_TARGET_DIR)
